...
<script>
	$(function() {		
		...
		kkpager.generPageHtml({
			...
			//链接前部
			hrefFormer : 'student_findAllChooseThCD',
			//链接尾部
			hrefLatter : '.action',
			getLink : function(n){
	...
	<div class="container-fluid">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<ul id="myTab" class="nav nav-tabs">
				<li><a href="student_findAllSelfChoosed.action">
						自主选题 的结果</a></li>
				<li class="active"><a href="#th" data-toggle="tab">选择老师指定的题目的结果</a></li>
				<li><a href="student_findAllChoosedCD.action">所有选题结果</a></li>
			</ul>
			<div id="myTabContent" class="tab-content">
				<div class="tab-pane fade" id="home">					
				</div>
				<div class="tab-pane fade in active" id="th">
					<!--查看所选择的内容-->
						...
						<tbody>
							<s:iterator value="#request.pageBean.list" id="cdtopic"
								...
								<tr>
									...
									<td><s:property value="#cdtopic[3]" /></td>									 								 								 									 							
									<td><input type="hidden"
										value="<s:property value="#cdtopic[4]" />" />
									...
									<td><input type="hidden"
										value="<s:property value="#cdtopic[5]" />" />
